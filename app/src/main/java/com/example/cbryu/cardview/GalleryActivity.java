...
public class GalleryActivity extends AppCompatActivity {
                    ...
                    if(data.getClipData() != null) {
                        ...
                        while(currentItem < count) {
                            ...
                            try {
                                ...
                                MyAdapter mAdapter = new MyAdapter(GalleryActivity.this, arrayList);
    ...
    private boolean askForPermission() {
        ...
        if (currentAPIVersion >= Build.VERSION_CODES.M) {
            int hasCallPermission = ContextCompat.checkSelfPermission(GalleryActivity.this,
        ...
        dialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface arg0) {
                dialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(
                        ContextCompat.getColor(GalleryActivity.this, android.R.color.holo_blue_light));
                dialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(
                        ContextCompat.getColor(GalleryActivity.this, android.R.color.holo_red_light));
            }
        });
